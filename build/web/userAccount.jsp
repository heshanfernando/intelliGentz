            ...
            <div class="row" >
                <div class="col-lg-12">
                    <div class="intro-message" style="background-color:#E8E8E8; opacity:0.95;">
                        <div style=" width:100%; position:absolute; top:10px; margin: 10px 0 0 0 ; padding-top: 10px;"><b><p style=" color:black; float:right; font-size:17px; margin-right: 10px;">Hi UserName!</p></b></div>
                        <div align="left" style=" position:absolute; top:25px; margin-left: 10px; ">
                                ...
                                <a><button  type="button" class="btn btn-primary" onclick="window.location.assign('history.jsp')" >History</button></a>
                        </div>
                        <div style=" width:100%; position:absolute; top:70px;" ><p style=" color:black; font-size:22px; opacity:0.8; text-shadow:2px 2px 5px grey;"> Registered shops</p></div>
                        <div>
							...
							<thead>
								<tr >
									...
									<th>Telephone Number</th>
                                                        ...
                                                        <tbody>
                                                            <tr id="shopInfo" style="cursor: " ondblclick="window.location.assign('editShop.jsp')">
                                                                <th>1</th>
                                                                <th>Edward shopping centre</th>
                                                                <th>No:25, Katubedda, Moratuwa</th>
                                                                <th>94715656548</th>
                                                            </tr>
                                                            <tr id="shopInfo" ondblclick="window.location.assign('editShop.jsp')">
                                                                <th>2</th>
                                                                <th>Edward2 shopping centre</th>
                                                                <th>No:25, Katubedda, Moratuwa</th>
                                                                <th>94715656548</th>
                                                            </tr>
                                                        </tbody>
