	...
	<script>
		...
		function setMarker(location) {
                ...
                function validateSelectedLocation(location){
                    ...
                    document.getElementById("longitudeOutput").innerHTML = ("Lat: "+markers[0].position.lat()+"Long:  "+markers[0].position.lng());
                }
            ...
            <div class="row" style="margin-top:30px;">
				...
				<div class="form-group" style=" float:left; margin:10px 10px 10px 10px; padding: 0 10px 0 0px;">
				  ...
				  <div class="form-group" style="float:center; margin-top:10px; color:black; position:flex;">
					<p>
					  <input type="checkbox" onChange="checkBoxFunction()"> Check this for verification
					</p>
                                        <input id='hiddenfield'  name='lat' onclick="document.getElementById('hiddenField').value=location.lat();">
				  <button type="submit" class="btn btn-default" disabled="true" id="submitButton" onclick="document.getElementById('hiddenField').value=location.lat;">Submit</button>
